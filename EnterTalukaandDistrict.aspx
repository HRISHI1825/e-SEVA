<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EnterTalukaandDistrict.aspx.cs" Inherits="EnterTalukaandDistrict" %>
...
<body>
    <div class="jumbotron">
  <center>  
   <h1>Enter Taluka and District</h1>
      </center>
      </div>
      <div class="progress">
 ...
 <div class="form-group">
        <asp:Label ID="lblTaluka" runat="server" Text="Taluka" 
            CssClass="col-lg-3 control-label"></asp:Label>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                        ControlToValidate="txtTaluka" 
            ErrorMessage="RequiredFieldValidator" Font-Bold="True" 
                        ForeColor="Red">*</asp:RequiredFieldValidator>
    <div class="col-lg-5">
        ...
        <asp:Button ID="btn1" runat="server" Text="Cancel" CssClass="btn btn-default" />
          <asp:Button ID="btn2" runat="server" Text="Submit" CssClass="btn btn-primary" OnClick="btn2_Click" />
                    <asp:SqlDataSource ID="Sqlds" runat="server" 
                        ...
                        InsertCommand="INSERT INTO [diststud] ([District], [Taluka]) VALUES (@District, @Taluka)" 
                        SelectCommand="SELECT [SrNo], [District], [Taluka] FROM [diststud]" 
                        
                        
                        
                        
                        UpdateCommand="UPDATE [diststud] SET [District] = @District, [Taluka] = @Taluka WHERE [SrNo] = @SrNo">
                        <DeleteParameters>
                        ...
                        <InsertParameters>
                            ...
                            <asp:ControlParameter ControlID="txtTaluka" Name="Taluka" PropertyName="Text" 
                                Type="String" />
                        </InsertParameters>
                        <UpdateParameters>
