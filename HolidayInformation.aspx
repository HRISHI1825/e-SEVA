<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HolidayInformation.aspx.cs" Inherits="HolidayInformation" %>
  ...
  <div class="progress-bar" style="width: 100%;"></div>
    ...
    <div class="col-lg-5">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            <Columns>
                <asp:BoundField DataField="HolidayEmployeeName" HeaderText="HolidayEmployeeName" 
                    SortExpression="HolidayEmployeeName" />
                <asp:BoundField DataField="HolidayDate" 
                    HeaderText="HolidayDate" SortExpression="HolidayDate" />
                <asp:BoundField DataField="HolidayReason" HeaderText="HolidayReason" 
                    SortExpression="HolidayReason" />
            </Columns>
        </asp:GridView>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT [HolidayEmployeeName], [HolidayDate], [HolidayReason] FROM [Office] WHERE (([HolidayYear] = @HolidayYear) AND ([HolidayDate] IS NOT NULL))">
            <SelectParameters>
