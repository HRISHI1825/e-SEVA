<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RajyaPuraskarGuide1n.aspx.cs" Inherits="RajyaPuraskarGuide1n" %>
 ...
 <center><h2>THE MAHARASHTRA STATE BHARAT SCOUTS AND GUIDES,<br /> Registration Form for Rajya Puraskar Guide Award.
  ...
  <div class="progress-bar" style="width: 100%;"></div>
    ...
    <fieldset>
        ...
        <div class="form-group">
             <asp:Label ID="lblNameOfTheGuide" runat="server"  class="col-lg-3 control-label" Text="Name Of The Guide"></asp:Label>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtNameOfTheGuide" ForeColor="Red" ToolTip="Enter Name of Guide">*</asp:RequiredFieldValidator>
           <div  class="col-lg-5">
            <asp:TextBox ID="txtNameOfTheGuide"  class="form-control" runat="server"></asp:TextBox>
        ...
        <div class="form-group">
           ...
           <div  class="col-lg-5">
            <asp:TextBox ID="txtAddressOfUnit" runat="server" class="form-control"  TextMode="MultiLine"></asp:TextBox>
         </div> </div>
        <div class="form-group">
             <asp:Label ID="lblCharterNo" runat="server"   class="col-lg-3 control-label" Text="Charter No."></asp:Label>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" 
                    ControlToValidate="txtCharterNo" ForeColor="Red" ToolTip="Enter Charter No.">*</asp:RequiredFieldValidator>
           <div  class="col-lg-5">
        ...
        <div class="form-group">
           ...
           <div class="col-lg-5">
             <asp:FileUpload ID="fuDateOfBirthCertificate" runat="server" CssClass="form-control"  />
                  ...
                  <div class="form-group">
            <asp:Label ID="lblSignatureOfGuideCaptain"   class="col-lg-3 control-label" runat="server" Text="Signature Of Guide Captain"></asp:Label>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="fuSignatureOfGuideCaptain" ForeColor="Red" 
                    ToolTip="Enter Signature Of Guide Captain">*</asp:RequiredFieldValidator>
           <div class="col-lg-5">
           <asp:FileUpload ID="fuSignatureOfGuideCaptain" runat="server" CssClass="form-control"  />
                 </div>   </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <asp:Label ID="lblGuideCaptainQualification"  class="col-lg-3 control-label" runat="server" Text="Guide Captain Qualification"></asp:Label>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" 
                    ControlToValidate="txtGuideCaptainQualification" ForeColor="Red" 
                    ToolTip="Enter Guide Captain Qualification ">*</asp:RequiredFieldValidator>
                  <div class="col-lg-5"> <asp:TextBox ID="txtGuideCaptainQualification" class="form-control"  runat="server"></asp:TextBox>
           </div>
           </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <asp:Label ID="lblSignatureOfDOC"   class="col-lg-3 control-label" runat="server" Text="Signature Of D.O.C."></asp:Label>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                    ControlToValidate="fuSignatureOfDOC" ForeColor="Red" 
                    ToolTip="Enter Date of Birth Certificate">*</asp:RequiredFieldValidator>
           <div class="col-lg-5">
           <asp:FileUpload ID="fuSignatureOfDOC" runat="server" CssClass="form-control"  />
                 </div>   </div>
        <div class="form-group">
      ...
      <hr />
            <asp:SqlDataSource ID="SqldsRajyaPuraskar" runat="server" 
                ...
                <InsertParameters>
                    ...
                    <asp:ControlParameter ControlID="txtNameOfTheGuide" Name="NameOfTheGuide" 
                        PropertyName="Text" Type="String" />
                    ...
                    <asp:ControlParameter ControlID="fuSignatureOfGuideCaptain" 
                        Name="SignatureOfGuideCaptain" PropertyName="FileName" Type="String" />
                    ...
                    <asp:ControlParameter ControlID="txtNameofUnitLeader" Name="NameOfUnitLeader" 
                        PropertyName="Text" Type="String" />
                    <asp:ControlParameter ControlID="txtGuideCaptainQualification" 
                        Name="GuideCaptainQualification" PropertyName="Text" Type="String" />
                    ...
                    <asp:ControlParameter ControlID="fuSignatureOfDOC" Name="SignatureOfDOC" 
