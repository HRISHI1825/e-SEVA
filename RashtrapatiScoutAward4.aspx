<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RashtrapatiScoutAward4.aspx.cs" Inherits="RashtrapatiScoutAward4" %>
...
<div class ="jumbotron">
  ...
  <div class="progress-bar" style="width: 100%;"></div>
    ...
    <div class="jumbotron">
        ...
        <table>
        <tr>
        <td align="right"><td align="center"><img src='RashtrapatiScoutAwardForm1Photo/<%#Eval("Photo") %>' alt="Not available" />
              </td>
        </tr>
        </table>
        <table style="width: 100%;">
          <tr>
            ...
            <tr>
                ...
                <td>
                 <asp:Label ID="NameofScout"  CssClass="col-lg-3 control-label" runat="server" Text='<%#Eval("NameofScout") %>'
                Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large"></asp:Label>  
                </td>
            </tr>
            <tr>
          ...
          <tr>
          <td align="center"><img src='RashtrapatiScoutAwardForm1SignofScoutMaster/<%#Eval("SignatureOfScoutMaster") %>' alt="Not available" />
           </td>
          <td align="center"><img src='RashtrapatiGuideAwardForm1SignofApplicant/<%#Eval("SignatureofApplicant") %>' alt="Not available" />
         </td>
          </tr>
          <tr>
          <td> <asp:Label ID="SignatureofScoutMaster" runat="server" Text="Signature of Scout Master"
                Font-Bold="True" Font-Names="Times New Roman" CssClass="col-lg-3 control-label" Font-Size="Large"></asp:Label>
           </td>
          ...
          <tr>
          <td> <asp:Label ID="lblScoutingQualification" runat="server"  CssClass="col-lg-3 control-label" Text="Scouting Qualification-Advanced/HWB Course Certificate No. "
                Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large"></asp:Label>
              </td>
          <td> <asp:Label ID="ScoutingQualification" runat="server"  CssClass="col-lg-3 control-label" Text='<%#Eval("ScoutingQualification")%>'
                Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large"></asp:Label>
              </td>
              <td><asp:Label ID="lblDateofScoutingQualification"  CssClass="col-lg-3 control-label"  runat="server" Text="Date"
                Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large"></asp:Label>
               </td>
          <td><asp:Label ID="DateofScoutingQualification"  CssClass="col-lg-3 control-label"  runat="server" Text='<%#Eval("DateofScoutingQualification")%>'
                Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large"></asp:Label>
               </td>
          </tr>
          <tr>
          <td><asp:Label ID="lblHWBParchmentNo" runat="server" CssClass="col-lg-3 control-label"  Text="HWB Parchment No."
                Font-Bold="True" Font-Names="Times New Roman"  Font-Size="Large"></asp:Label>
               </td>
          <td><asp:Label ID="HWBParchmentNo" runat="server" CssClass="col-lg-3 control-label"  Text='<%#Eval("HWBParchmentNo")%>'
                Font-Bold="True" Font-Names="Times New Roman"  Font-Size="Large"></asp:Label>
               </td>
          ...
          <tr>
          <td align="center"></td><img src='RashtrapatiGuideAwardForm1SignofDistCommG/<%#Eval("SignOfDistrictCommissionerS") %>' alt="Not available" />
          <td align="center"></td><img src='RashtrapatiGuideAwardForm1SignofDistComm/<%#Eval("SignOfDisttCommissioner") %>' alt="Not available" />
          </tr>
           <tr>
          <td><asp:Label ID="lblSignatureOfDistrictCommissionerS" runat="server"  CssClass="col-lg-3 control-label" Text="Signature Of District Commissioner(S)"
                Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large"></asp:Label>
            </td>
          <td> <asp:Label ID="lblSignatureOfDisttCommissioner" runat="server"  CssClass="col-lg-3 control-label" Text="Signature Of Distt. Commissioner"
           ...
           <tr>
          <td align="center"><asp:Label ID="lblDateSignDistCommS" runat="server" Text="Date"
                Font-Bold="True" Font-Names="Times New Roman"  CssClass="col-lg-3 control-label"  Font-Size="Large"></asp:Label>
          ...
          <tr>
          <td align="center"><img src='RashtrapatiGuideAwardForm1SignofStateOrgCommG/<%#Eval("SignStateOrgCommS") %>' alt="Not available" /></td>
          <td align="center"><img src='RashtrapatiGuideAwardForm1SignofStateSec/<%#Eval("SignStateSecretary") %>' alt="Not available" /></td>
          </tr>
           <tr>
          <td><asp:Label ID="lblSignStateOrgCommS" runat="server"  CssClass="col-lg-3 control-label" Text="Signature Of State Org. Commissioner(S)"
                Font-Bold="True" Font-Names="Times New Roman" Font-Size="Large"></asp:Label>
            </td>
          ...
          <td> <asp:Label ID="DateSignStateOrgComm" runat="server" Text='<%#Eval("DateSignStateOrgCommS")%>'
                Font-Bold="True" Font-Names="Times New Roman"  CssClass="col-lg-3 control-label"  Font-Size="Large"></asp:Label>
               </td>
          </tr>
          </td>
