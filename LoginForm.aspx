<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoginForm.aspx.cs" Inherits="StarryNightMoving_StarryNightMoving_LoginForm" %>
...
<body bgcolor="#CCFFFF" >
    ...
    <label class="lf--label" for="username">
     ...
     <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                 ControlToValidate="txtUsername" ErrorMessage="Invalid Username Format" 
                 Font-Bold="True" Font-Names="Times New Roman" ForeColor="Red" 
  ...
  <div class="flex-row">
   ...
   <%--   <asp:RangeValidator ID="RangeValidator1" runat="server" 
          ...
          ErrorMessage="Password must be of atleast 8 characters" Font-Bold="True" 
          Font-Names="Times New Roman" ForeColor="Red"></asp:RangeValidator>--%>
