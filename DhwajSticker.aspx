<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DhwajSticker.aspx.cs" Inherits="DhwajSticker" %>
...
<form id="form1" runat="server" class="form-horizontal">
    ...
    <tr><td class="style1"></td><td align="center">
          <h1>Flag Sticker Information</h1></td>
          <td align="right">
              <asp:ImageButton ID="ImageButton1" runat="server" Height="60px" 
                  ImageUrl="~/icons/next.png" PostBackUrl="~/dhwajsticker1.aspx" 
                  ToolTip="Enter New Flag Sticker Information" Width="60px" /></td>
          </tr>
    </table>
        </center>
        </div>        
...
<div class="form-group">
    ...
    <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlUnitNames" Width="100%">
        ...
        <div class="form-group"><div class="col-lg-5">
            <a href='DhwajSticker2.aspx?UnitName=<%# Eval("UnitName") %>&Year=<%#Eval("Year") %>'><asp:Label ID="UnitNameLabel" runat="server" Text='<%# Eval("UnitName") %>' CssClass="col-lg-9 control-label"/></a>
        </div></div>
        </ItemTemplate>
        <SeparatorTemplate>
        <hr width="1px" />
