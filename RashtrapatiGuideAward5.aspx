<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RashtrapatiGuideAward5.aspx.cs" Inherits="RashtrapatiGuideAward5" %>
    ...
    <div class="jumbotron">
        ...
        <fieldset >
            <table style="width: 100%;">
                ...
                <tr>
                    <td><asp:Label ID="lblNameoftheGuide" runat="server" CssClass="col-lg-3 control-label "  Font-Size="Large" Font-Names="Times New Roman" 
  ...
  <caption>
   ...
   <table width="100%" style=" border-collapse:collapse" class="table table-striped table-hover ">
    ...
    <table width="50%" align="right">
        <tr>
        <td align="right"><td align="center"><img src='RashtapatiGuideAwardForm2SignatureofGuide/<%#Eval("SignofGuide") %>' alt="Not available" />
              </td>
     ...
     <table "width:50%">
     <tr>
      <td align="right"><td align="center"><img src='RashtapatiGuideAwardForm2SignatureofGuideCaptain/<%#Eval("SignofGuideCaptain") %>' alt="Not available" />
              </td>
     </tr>
        <tr>
            <td>
