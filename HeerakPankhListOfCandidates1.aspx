...
<form id="form1" runat="server" class="form-horizontal">
   ...
   <asp:DropDownList ID="DropDownList1" runat="server" CssClass="dropdown" 
       ...
       <td class="style1">
           ...
           <td>
           <a href='HeerakPankhFormPrintForUser.aspx?NameOfTheBulbul=<%#Eval("NameOfTheBulbul") %>'><asp:label ID="label1" runat="server" Text="Click To See" CssClass="control-label"></asp:label></a>
           </td>
       </tr>
       </table>
