<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChaturthCharanFormPrint.aspx.cs" Inherits="ChaturthCharanFormPrint" %>
       ...
       <tr><td>
        ...
        <tr><td>
         ...
         <asp:SqlDataSource ID="SqldsChaturthCharan" runat="server" 
            ...
            SelectCommand="SELECT SrNo, NameOfTheDistrict, NameOfTheCub, Address, Dist, PinCode, DateOfBirth, NameOfTheGroup, AddressOfTheGroup, NameOfTheCubMaster, CertificateNo, Date, WarrantNo, DateOfJoiningCub, DateOfCompletionOfPravesh, DateOfInvestiture, DateOfCompletionOfPrathamCharan, DateOfCompletionOfDwitiyaCharan, DateOfCompletionOfTritiyaCharan, NameOfTheProficiencyBadgeearned, DateOfCompletionOfChaturthCharan, NameOfTheProficiencyBadgeearned1, SignatureOfCubMaster, SignatureOfCub, Status FROM ChaturthCharan WHERE (NameOfTheCub = @NameOfTheCub)">
            <SelectParameters>
                <asp:SessionParameter Name="NameOfTheCub" SessionField="NameOfTheCub" 
                    Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
