    ...
    <fieldset>
       ...
       <hr />
            <asp:SqlDataSource ID="SqldsStateCommittee" runat="server" 
                ...
                InsertCommand="INSERT INTO [Office] ([StateMemberName], [StateMemberCommitteeName], [StateMemberHomeAddress], [StateMemberSchoolName], [StateMemberSchoolAddress], [StateMemberPositionName], [StateMemberDuration], [StateMemberDateOfBirth], [StateMemberEmailId], [StateMemberContactNo]) VALUES (@StateMemberName, @StateMemberCommitteeName, @StateMemberHomeAddress, @StateMemberSchoolName, @StateMemberSchoolAddress, @StateMemberPositionName, @StateMemberDuration, @StateMemberDateOfBirth, @StateMemberEmailId, @StateMemberContactNo)" 
