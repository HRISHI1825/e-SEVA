<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChaturthCharanListOfCandidates.aspx.cs" Inherits="ChaturthCharanListOfCandidates" %>
...
<form id="form1" runat="server" class="form-horizontal">
   <fieldset>
   <center>
       <asp:CheckBoxList ID="CheckBoxList1" runat="server" DataSourceID="sqldsChaturthCharan" 
           DataTextField="NameOfTheCub" DataValueField="NameOfTheCub">
       </asp:CheckBoxList>
    ...
    <tr><td rowspan="2" width="107px" align="center">
     ...
     <center>   
         <asp:HyperLink ID="HyperLink2" runat="server" Font-Bold="True" 
             ...
             NavigateUrl="~/Admin2.aspx">Home</asp:HyperLink></center>
