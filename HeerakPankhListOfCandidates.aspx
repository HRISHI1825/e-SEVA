<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HeerakPankhListOfCandidates.aspx.cs" Inherits="HeerakPankhListOfCandidates" %>
...
<form id="form1" runat="server" class="form-horizontal">
   <fieldset>
   <center>
       <asp:CheckBoxList ID="CheckBoxList1" runat="server" DataSourceID="sqldsHeerakPankh" 
           DataTextField="NameOfTheBulbul" DataValueField="NameOfTheBulbul">
       </asp:CheckBoxList>
        <asp:SqlDataSource ID="sqldsHeerakPankh" runat="server" 
           ...
           SelectCommand="SELECT [NameOfTheBulbul] FROM [HeerakPankh] WHERE ([Status] = @Status)">
            <SelectParameters>
