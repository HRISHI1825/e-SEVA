<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Adhikar.aspx.cs" Inherits="Adhikar1" %>
...
<div class="jumbotron">
 <center>
    ...
    <tr><td class="style2"></td><td align="center" class="style1">
          <h1>Adhikar Patra Information</h1></td>
          <td align="right">
              <asp:ImageButton ID="ImageButton1" runat="server" Height="60px" 
                  ImageUrl="~/icons/next.png" PostBackUrl="~/Adhikar1.aspx" 
                  ToolTip="Enter New Adhikar Patra Information" Width="60px" /></td>
          </tr>
    </table>
 </center>
    </div>      
...
<div class="form-group">
    <asp:Label ID="lblUnitName" runat="server" Text="Select Unit Name" CssClass="col-lg-3 control-label"></asp:Label>
    <div class="col-lg-5">
        ...
        <asp:SqlDataSource ID="Sqlds" runat="server" 
            ...
            SelectCommand="SELECT [UnitName] FROM [UnitLeaderTable] WHERE (([Year] = @Year) AND ([SchoolName] = @SchoolName) AND ([UnitName] IS NOT NULL))">
            <SelectParameters>
                <asp:ControlParameter ControlID="DropDownList3" Name="Year" 
                    PropertyName="SelectedValue" Type="String" />
    ...
    <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlFullName" 
        Width="100%">
        <ItemTemplate>
        <div class="form-group"><div class="col-lg-5">
            <a href='Adhikar2.aspx?FullName=<%# Eval("FullName") %>&Year=<%#Eval("Year") %>&SchoolName=<%#Eval("SchoolName") %>&UnitName=<%#Eval("UnitName") %>' class="col-lg-9 control-label"><asp:Label ID="FullNameLabel" runat="server" Text='<%# Eval("FullName") %>' /></a>
        </div></div>
        </ItemTemplate>
        <SeparatorTemplate>
        <hr width="1px" />
    ...
    <asp:SqlDataSource ID="SqlFullName" runat="server" 
        ...
        SelectCommand="SELECT [FullName], [Year], [SchoolName], [UnitName] FROM [UnitLeaderTable] WHERE (([SchoolName] = @SchoolName) AND ([UnitName] = @UnitName) AND ([Year] = @Year))">
        <SelectParameters>
            <asp:ControlParameter ControlID="DropDownList2" Name="SchoolName" 
                PropertyName="SelectedValue" Type="String" />
