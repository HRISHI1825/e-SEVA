<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChaturthCharanListOfCandidates1.aspx.cs" Inherits="ChaturthCharanListOfCandidates1" %>
...
<form id="form1" runat="server" class="form-horizontal">
   ...
   <asp:DropDownList ID="DropDownList1" runat="server" CssClass="dropdown" 
       ...
       <tr>
       <td class="style1">
           <asp:Label ID="NameOfTheCubLabel" runat="server" Text='<%#Eval("NameOfTheCub") %>' CssClass="control-label"></asp:Label></td>
           <td>
           <a href='ChaturthCharanFormPrintForUser.aspx?NameOfTheCub=<%#Eval("NameOfTheCub") %>'><asp:label ID="label1" runat="server" Text="Click To See" CssClass="control-label"></asp:label></a>
           </td>
       </tr>
       </table>
        ...
        <asp:SqlDataSource ID="sqldsChaturthCharan" runat="server" 
           ...
           SelectCommand="SELECT [NameOfTheCub] FROM [ChaturthCharan] WHERE ([Status] = @Status)">
            <SelectParameters>
