...
<body>
    ...
    <tr><td class="style2"></td><td align="center" class="style1">
          <h1>Audit Reports</h1></td>
          <td align="right">
              <asp:ImageButton ID="ImageButton1" runat="server" Height="60px" 
                  ImageUrl="~/icons/next.png" PostBackUrl="~/AuditReport1.aspx" 
                  ToolTip="Enter New Audit Report" Width="60px" /></td>
          </tr>
    </table>
            </center>
      </div>
...
<fieldset>
  <center>
 <asp:Repeater ID="Repeater1" runat="server" DataSourceID="sqldsAuditReport">
 <HeaderTemplate>
 ...
 <table  cellpadding="2" cellspacing="2" class="table-hover" style="border-collapse:collapse">
 <tr>
 <td style="border-collapse:collapse" class="style3"><asp:label id="lblYear1" runat="server" text='<%#Eval("AuditReportYear") %>' CssClass="control-label"></asp:label></td>
 <td style="border-collapse:collapse" class="style4" align="center"><a href='AuditReport/<%#Eval("AudiReport") %>'><asp:Label ID="lblReport" runat="server" Text="Report" CssClass="col-lg-3 control-label"></asp:Label></a></td>
 </tr>
 </table>
 </ItemTemplate>
 <SeparatorTemplate>
    <hr width="1px" />
        ...
        SelectCommand="SELECT [AuditReportYear], [AudiReport] FROM [Office] WHERE ([AuditReportYear] IS NOT NULL)"></asp:SqlDataSource>
            </fieldset>
    </div>
