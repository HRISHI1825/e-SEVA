<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RajyaPuraskarGuideListOfCandidates.aspx.cs" Inherits="RajyaPuraskarGuideListOfCandidates" %>
...
<form id="form1" runat="server" class="form-horizontal">
   ...
   <center>
       <asp:CheckBoxList ID="CheckBoxList1" runat="server" DataSourceID="sqldsRajyaPuraskar" 
           DataTextField="NameOfTheGuide" DataValueField="NameOfTheGuide" >
       </asp:CheckBoxList>
