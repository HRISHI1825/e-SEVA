...
<form id="form1" runat="server" class="form-horizontal">
   ...
   <asp:DropDownList ID="DropDownList1" runat="server" CssClass="dropdown" 
       ...
       <td class="style2">
           ...
           <td>
           <a href='MainRajyaPuraskarScout.aspx?NameOfTheScout=<%#Eval("NameOfTheScout") %>'><asp:label ID="label1" runat="server" Text="Click To See" CssClass="control-label"></asp:label></a>
           </td>
       </tr>
       </table>
